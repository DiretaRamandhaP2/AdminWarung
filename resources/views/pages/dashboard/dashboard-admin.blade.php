...
@section('main')
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <div class="group bg-white p-6 rounded-3xl border border-green-light-primary shadow-xs hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
            <div class="flex justify-between items-start">
                ...
                <div class="p-4 bg-blue-primary/10 text-blue-primary rounded-2xl group-hover:bg-blue-primary group-hover:text-white transition-colors duration-300">
        ...
        <div class="group bg-white p-6 rounded-3xl border border-green-light-primary shadow-xs hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <h3 class="text-2xl font-black text-gray-800 tracking-tight">248 <span class="text-sm font-medium text-gray-400">SKU</span></h3>
                    <div class="mt-2 flex items-center">
                ...
                <div class="p-4 bg-green-dark-primary/10 text-green-dark-primary rounded-2xl group-hover:bg-green-dark-primary group-hover:text-white transition-colors duration-300">
        ...
        <div class="group bg-white p-6 rounded-3xl border border-green-light-primary shadow-xs hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <h3 class="text-2xl font-black text-gray-800 tracking-tight">42 <span class="text-sm font-medium text-gray-400">Orang</span></h3>
                    <div class="mt-2 flex items-center">
                        <span class="flex items-center text-xs font-bold text-green-500 bg-green-50 px-2 py-1 rounded-lg">
                ...
                <div class="p-4 bg-yellow-400/10 text-yellow-600 rounded-2xl group-hover:bg-yellow-400 group-hover:text-white transition-colors duration-300">
    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-2">
                <button class="bg-white border border-gray-200 p-2 rounded-xl hover:bg-gray-50 transition shadow-sm text-gray-600">
                    <i class="fa-solid fa-calendar-day"></i>
                </button>
                <button class="bg-blue-primary text-white px-4 py-2 rounded-xl hover:bg-blue-primary/90 transition shadow-md shadow-blue-primary/20 text-sm font-bold">
                    Cetak Laporan
                </button>
            </div>
        </div>
        ...
        <section id="diagram" class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div class="lg:col-span-5 bg-white shadow-xl shadow-gray-100/50 border border-green-light-primary rounded-[2rem] p-8">
            ...
            <div class="lg:col-span-7 bg-white shadow-xl shadow-gray-100/50 border border-green-light-primary rounded-[2rem] p-8 flex flex-col">
                <div class="flex items-center justify-between mb-8">
                    <div>
                    ...
                    <button class="flex items-center gap-2 text-xs bg-green-light-primary/50 text-green-dark-primary px-4 py-2 rounded-xl font-black hover:bg-green-dark-primary hover:text-white transition-all duration-300">
